...
{
    public class TestEventBusHandler : ITestEventBusHandler
    {
        private static ServiceBusClient _serviceBusClient;
        private readonly ServiceBusSender _sender;
        private readonly ServiceBusProcessor _processor;

        public TestEventBusHandler(string connectionString, string queueName, Func<ProcessMessageEventArgs, Task> messageEventFunction, Func<ProcessErrorEventArgs, Task> errorEventFunction)
        {
